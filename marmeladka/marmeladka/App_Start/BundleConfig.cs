...
namespace marmeladka.App_Start
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/otherjs").Include("~/content/js/js/bootstrap.min.js", "~/content/js/js/main.js"));

            bundles.Add(new StyleBundle("~/bundles/css").Include("~/content/css/bootstrap.min.css",
                "~/content/css/prettyPhoto.css", "~/content/css/animate.css",
                "~/content/css/main.css", "~/content/css/responsive.css", "~/content/css/font-awesome.min.css", "~/content/css/tooltip-classic.css",
